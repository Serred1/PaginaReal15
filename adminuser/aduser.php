        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <h6 class="collapse-header" style="color: black;">Aprendizaje</h6>
                        <a class="collapse-item" href="../encuestas/quiz1.php">Encuesta de Prueba</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header" style="color: black;">Pantalla de Inicio</h6>
                        <a class="collapse-item" href="..//inicio/foro.php">Inicio</a>
                    </div>
                </div>
            </li>
